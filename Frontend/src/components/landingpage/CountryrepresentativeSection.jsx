...
function CountryrepresentativeSection() {
  ...
  const nextSlide = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 1) % representatives.length);
  };

  const prevSlide = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 1 + representatives.length) % representatives.length);
  };
          ...
          <div className="overflow-hidden">
            ...
            >
              {representatives.map((rep) => (
                <div key={rep.id} className="min-w-full">
                  <div className="group bg-white rounded-xl shadow-md overflow-hidden transform transition duration-300 hover:shadow-lg">
