...
const CollegeInfo = ({ countryName }) => {
  const overview = {
    popularChoice:
      "The UnitedStates Medical Universities have been a popular choice among the Indian students seeking to study MBBS abroad. Over the last few decades, as many as 50,000 Indian medical students have achieved their dream of becoming a doctor with the top government medical universities of Russia. Even as of today, 5000+ Indian students are studying MBBS in Russia and are on their way of achieving their dream.",
    russiaAsAHub:
      "Russia is known to be a land of supremes and as a global 'superpower' it is often a hub of research and innovations. Thus, the students pursuing the highest education in Russia get to experience the benefits of abundant exposure in the terms of career and opportunities.",
    indianRussiaRelations:
      "The healthy diplomatic relations between India and Russia often make the entire admission procedure and experience noteworthy and hence bring it to the list of the best countries for the Indian students looking for MBBS admissions abroad.",
  };
    ...
    <div className="bg-white rounded-lg p-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <p className="text-gray-800">
                Tuition: {courseOverview.averageCost.tuition}
              </p>
              <p className="text-gray-800">
                Living: {courseOverview.averageCost.living}
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-800">
                {courseOverview.totalMedicalUniversities}
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-800">
                IELTS/TOEFL: {courseOverview.requirements.ielts_toefl}
              </p>
              <p className="text-gray-800">
                NEET: {courseOverview.requirements.neet}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-100 rounded-lg p-6">
          ...
          <p className="text-gray-800">
            General: {eligibilityRequirements.marks.general}%
          </p>
          <p className="text-gray-800">
            Reserved: {eligibilityRequirements.marks.reserved}%
          </p>
        </div>
        <div className="bg-gray-100 rounded-lg p-6">
          <p className="text-gray-500 font-medium">Age Range</p>
          <p className="text-gray-800">
            Minimum: {eligibilityRequirements.ageRange.min} years
          </p>
          <p className="text-gray-800">
            Maximum: {eligibilityRequirements.ageRange.max} years
          </p>
        </div>
        <div className="bg-gray-100 rounded-lg p-6">
          <p className="text-gray-500 font-medium">NEET Requirement</p>
          <p className="text-gray-800">
            General: {eligibilityRequirements.neet.general} percentile
          </p>
          <p className="text-gray-800">
            Reserved: {eligibilityRequirements.neet.reserved} percentile
          </p>
        </div>
      </div>
